...
\addbibresource{references.bib}  % Your .bib file WITH extension
...
%===============================================================
% Notation & Definitions (Particle Masses)
%===============================================================
\begin{center}
\fbox{\begin{minipage}{0.95\textwidth}\small
\textbf{Notation \& Definitions (particle masses)}\par\medskip
\begin{itemize}
  \item $\displaystyle \varphi=\frac{1+\sqrt{5}}{2}$, \quad $E_{\rm coh}=\varphi^{-5}$ \;(sector--coherence factor).
  \item $B_i$ \;(sector baseline; $B=1$ for charged leptons; see Appendix H.5 for general sector prefactors).
  \item $r_i\in\mathbb{Z}$ \;(rung index; absolute shifts are immaterial to ratios and invariants; a convenient lepton choice is $r_e=0$, $r_\mu=11$, $r_\tau=17$).
  \item $f_i(\cdot)$ \;(fractional residue from $\varphi$--sheet RG average $+$ gap series; evaluated self--consistently at the fixed point).
